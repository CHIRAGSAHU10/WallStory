...
const Manifesto = () => {
  return (
    <section
      ...
      className="relative bg-[#0A0A0A] py-28 md:py-40"
    >
      <div className="max-w-[1600px] mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 mb-20 md:mb-32">
          ...
          <div className="md:col-span-8">
            <RevealLines
              className="font-serif font-light text-[var(--ivory)] text-4xl md:text-6xl lg:text-7xl h-display"
        ...
        <div className="space-y-0">
          {chapters.map((c, i) => (
            <FadeUp key={c.no} delay={i * 0.05}>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-16 py-12 md:py-16 border-t border-white/10 group">
                <div className="md:col-span-2">
                  <span className="font-serif text-5xl md:text-7xl text-[var(--gold)] font-light">
                    {c.no}
                  </span>
                </div>
                <div className="md:col-span-6">
                  <h3 className="font-serif text-3xl md:text-5xl font-light text-[var(--ivory)] leading-tight group-hover:translate-x-2 transition-transform duration-700">
                    {c.title}
                  </h3>
                </div>
                <div className="md:col-span-4">
